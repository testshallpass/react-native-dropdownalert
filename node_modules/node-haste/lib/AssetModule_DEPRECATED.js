...
var AssetModule_DEPRECATED = function (_Module) {
  ...
  function AssetModule_DEPRECATED(args, platforms) {
    _classCallCheck(this, AssetModule_DEPRECATED);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AssetModule_DEPRECATED).call(this, args));

    var _getAssetDataFromName = getAssetDataFromName(_this.path, platforms);
